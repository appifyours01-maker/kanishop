...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/kanishop_app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '6a70a3ede439110587691255',
...
app.listen(PORT, () => {
  ...
  console.log(`kanishop Backend Server running on port ${PORT}`);
